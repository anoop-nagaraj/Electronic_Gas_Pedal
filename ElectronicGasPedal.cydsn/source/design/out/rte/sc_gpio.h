...
/**
*  file    SC_GPIO_signal.h 
*
*  brief   signal base class for signal sc_gpio
*
...
#ifndef SC_GPIO_SIGNAL_H_INCLUDED
#define SC_GPIO_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*SC_GPIO_driverIn_t)(SC_GPIO_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*SC_GPIO_driverOut_t)( const SC_GPIO_data_t * const);
...
/**
 * Instances of the struct SC_GPIO_cfg_t represent the signal object configuration.
 */
struct SC_GPIO_cfg_s
{
    /**
     * Function pointer to the input driver
     */
    SC_GPIO_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   SC_GPIO_driverOut_t const outDriver;
...
typedef const struct SC_GPIO_cfg_s SC_GPIO_cfg_t;
...
/**
 * Instances of the struct SC_GPIO_t represent the signal objects.
...
{                                                                                                                      
     ...
     */
	const SC_GPIO_cfg_t * const    pSigCfg;

};                                                                                                                     
typedef struct SC_GPIO_s SC_GPIO_t;
 ...
 *
 * @param  SC_GPIO_t * const signal: Pointer to the signal object which will be initialised
 * @param const sc_gpio_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_GPIO_init( SC_GPIO_t * const signal, const SC_GPIO_data_t * const value )
{                                                                                                                      
 ...
 *
 * @param  SC_GPIO_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
inline RTE_signalStatus_t RTE_SC_GPIO_getStatus( const SC_GPIO_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_SC_GPIO_setStatus( SC_GPIO_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_SC_GPIO_getAge( const SC_GPIO_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_SC_GPIO_incAge(  SC_GPIO_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  SC_GPIO_t * const signal: Pointer to the signal object
 * @return sc_gpio_data_t: current value of the application data buffer
 *
 **/
inline SC_GPIO_data_t RTE_SC_GPIO_get( const SC_GPIO_t * const signal )
{               
 ...
 *
 * @param  SC_GPIO_t * const signal: Pointer to the signal object
 * @param  SC_GPIO_data_t* data: Pointer to the return data Pointer to the signal object
 * @return RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_GPIO_getThreadSafe( const SC_GPIO_t * const signal, SC_GPIO_data_t * const data )
{    
 ...
 *
 * @param  SC_GPIO_t * const signal: Pointer to the signal object
 * @param  sc_gpio_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_GPIO_set(SC_GPIO_t * const signal, const SC_GPIO_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_SC_GPIO_pullPort( SC_GPIO_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {
	  SC_GPIO_data_t value = signal->value;
      ret = signal->pSigCfg->inDriver(&value);
                                                                                                                       
      if ( ret == RC_SUCCESS )                                                                                         
      {
    	  //Critical Section
    	  RTE_SC_GPIO_set(signal, value);
      }
      else
      {
		  //Signal is invalid. Error event (if present) will be fired
		  RTE_SC_GPIO_setStatus(signal, RTE_SIGNALSTATUS_INVALID);
      }
 ...
 *
 **/
inline RC_t RTE_SC_GPIO_pushPort( const SC_GPIO_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
