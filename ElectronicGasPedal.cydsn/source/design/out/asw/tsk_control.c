...
const RTE_eventTable_t RTE_eventActivationTable_tsk_control[] = {
    { CONTROL_calcControl_run, ev_joystick_onData },  //Runnable to check value of joystick signal and update speed signal
}; 
...
/*
* description: Task control will call the application code (control algorithm)
